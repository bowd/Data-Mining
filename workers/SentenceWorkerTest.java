...
class SentenceWorker {
  ...
  public static void main(String[] args) throws java.io.IOException, java.lang.InterruptedException {
    ...
    while (true) {
      ...
      String tweet_text = "RT @zepadeedoodah: Hello Xanax, goodnight cruel world...";
      String parsedText = "";

      for (List<HasWord> sentence : new DocumentPreprocessor(new StringReader((String) tweet_text))) {
