...
CPPPATH_NODE = '/fs/linserver/data1/mbax9bd2/builds/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
...
LIBDIR = '/fs/linserver/data1/mbax9bd2/.node_libraries'
LIBPATH_NODE = '/fs/linserver/data1/mbax9bd2/builds/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/fs/linserver/data1/mbax9bd2/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/fs/linserver/data1/mbax9bd2/builds'
